...
/// + 11 craftable ones — see CraftingRecipe). Only the first `hotbarSlotCount`
...
final class Hotbar {
    ...
    // 18 raw+crafted block/tool types (creativeLoadout) plus 4 animal-drop
